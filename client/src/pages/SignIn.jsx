...
import Logo from "../assets/Social-Sync.png";
  ...
  return (
        ...
        <form className="w-full max-w-md">
          ...
          <div className="mt-6 flex items-center justify-center">
            <Link
              to={"/signin"}
              className="w-1/3 border-b-2 border-blue-500 pb-4 text-center font-medium text-white "
            >
              Sign In
            </Link>
            <Link
              to={"/signup"}
              className="w-1/3 border-b border-gray-400 pb-4 text-center font-medium text-white "
            >
              Sign Up
            </Link>
          </div>
        ...
        <span className="flex items-center justify-center py-4 text-sm text-White ">
          ...
          >
            <MdOutlineAdminPanelSettings className="mr-1 h-5 w-4" />
            <span>Admin</span>
          </Link>
        </span>
      </div>
